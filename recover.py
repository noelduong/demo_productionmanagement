...
head_scripts = """  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />
  <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/luxon@3.3.0/build/global/luxon.min.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/chartjs-adapter-luxon@1.3.1/dist/chartjs-adapter-luxon.min.js"></script>"""
html = html.replace('  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />', head_scripts)

# 2. Add menu items
menu_items = """    <div class="nav-item" onclick="switchTab('dashboardTab', this)" style="border-left: 4px solid transparent;">
...
html = html.replace('    <div class="nav-item active" onclick="switchTab(\'createTab\', this)">', menu_items)
...
tabs_html = """
    ...
    <!-- TAB: HISTORY -->"""
html = html.replace('    <!-- TAB: HISTORY -->', tabs_html)
...
switch_logic = """
      ...
      if (tabId === "historyTab") {"""
html = html.replace('      if (tabId === "historyTab") {', switch_logic)

# 5. Add initDashboardData to DOMContentLoaded
init_logic = """      loadPODataFromSheet();
      loadImagesFromSheet();
      loadFactoryTabs();
      loadBOMFromSheet();
      loadDashboardData();
...
js_funcs = """
      ...
      fetch(WEB_APP_URL + "?action=getHistory").then(r => r.json()).then(res => {
          ...
          res.data.forEach(order => {
             html += `<tr>
                   ...
                   <td><input type="text" id="npl_note_${order.orderNo}" class="form-control" value="${order.syncNote || ''}" placeholder="Ghi chú..." style="padding:4px;"></td>
    ...
    /* ================= HISTORY ================= */"""
html = html.replace('    /* ================= HISTORY ================= */', js_funcs)
