...
const nplStart = '<!-- TAB: NPL & APPROVAL -->';
const historyStart = '<!-- TAB: HISTORY -->';

const startIndex = html.indexOf(nplStart);
const endIndex = html.indexOf(historyStart);
...
if (startIndex !== -1 && endIndex !== -1 && endIndex > startIndex) {
    ...
    fs.writeFileSync('index.html', before + cleanNplTab + after, 'utf8');
